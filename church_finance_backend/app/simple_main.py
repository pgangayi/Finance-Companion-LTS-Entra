...
from app.routes import provinces, transactions, bulk_upload, financial_statements, analytics, budgets, obligations, departments, projects
# from app.middleware.auth_middleware import auth_middleware  # Excluding auth middleware for now
...
# Add custom middleware (excluding auth middleware for now)
# app.middleware("http")(auth_middleware)
app.middleware("http")(audit_middleware)

# Include routers (excluding auth router for now)
